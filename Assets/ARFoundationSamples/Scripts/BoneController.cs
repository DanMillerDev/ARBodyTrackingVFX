...
public class BoneController : MonoBehaviour
{
    ...
    public Transform GetTrackedJoint(JointIndices jointIndex)
    {
        if (m_BoneMapping[(int)jointIndex] != null)
        {
    ...
    public Transform LeftHandJoint
    {
        get
        {
            if (m_BoneMapping[52] != null)
                return m_BoneMapping[52];
            else
                return null;
        }
    }
    ...
    public Transform RightHandJoint
    {
        get
        {
            if (m_BoneMapping[23] != null)
                return m_BoneMapping[23];
            else
                return null;
        }
    }
